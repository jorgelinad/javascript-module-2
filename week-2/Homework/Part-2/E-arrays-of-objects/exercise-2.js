...
let destinationNameReachableByFerry = travelDestinations.filter((destination) => destination.transportations.includes((destination) => destination == "ferry")).destinationName;// Complete here
